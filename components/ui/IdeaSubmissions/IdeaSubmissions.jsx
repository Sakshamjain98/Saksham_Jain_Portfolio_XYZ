      ...
      >
        ...
        >
          <div className="flex w-full">
            <div
              className={`${formCount === 2 || formCount === 3
            ...
            <div
              className={`${formCount === 1 || formCount === 3
                  ? "w-0 hidden opacity-0"
            ...
            <div
              className={`${formCount === 1 || formCount === 2
                  ? "w-0 hidden opacity-0"
          ...
          <div
            className={`w-[80%] flex ${formCount == 1 ? "justify-center" : "justify-between"
              } text-lg mt-3 mb-8 md:mb-8 lg:mb-0`}
          >
            <button
              onClick={handlePrev}
              className={` ${formCount == 1 && "hidden"
